...
import ru.netology.nmedia_practice.dao.PostDaoImpl.PostColumns
...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_SEND} BOOLEAN NOT NULL DEFAULT 0,
            ${PostColumns.COLUMN_COUNT_SEND} INTEGER NOT NULL DEFAULT 0,
    ...
    object PostColumns {
        ...
        const val COLUMN_SEND = "send"
        const val COLUMN_COUNT_SEND = "countSend"
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                send = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_SEND)) != 0,
                countSend = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_COUNT_SEND)),
